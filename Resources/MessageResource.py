...
class MessagesListResource(Resource):
    def post(self):
        ...
        parser.add_argument('e-mail', help = 'e-mail can\'t be blank', required = True, location = 'body')
        parser.add_argument('title', help = 'title can\'t be blank', required = True, location = 'body')
        parser.add_argument('message','message can\'t be blank', required = True, location = 'body')
